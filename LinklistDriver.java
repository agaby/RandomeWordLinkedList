...
//		myList.addInOrder("Hello");
//		myList.addInOrder("Bye");
//		myList.addInOrder("Goaway");
//		myList.Dislplay();
//		System.out.println();
//		myList.erase("Hello");
//		myList.Dislplay();
		...
		do{
		System.out.println();
		System.out.println("Welcom to LinkList \n choose one of the follwowing options. A for adding words, D for deleting words, Q for Quit");
